...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .btn-edit { flex: 1; padding: 12px; background: #3498db; color: white; border-radius: 6px; font-weight: 600; text-align: center; text-decoration: none; }
        ...
        <div class="main-content">
            ...
            <div class="details-card">
                ...
                <div class="right-column">
                    ...
                    <div class="btn-group">
                        <a href="view_inventory.php" class="btn-back">Back</a>
                        <a href="update_product.php?id=<?php echo $product_id; ?>" class="btn-edit">
                            <i class="fas fa-edit"></i> Edit / Mark Sold
                        </a>
                    </div>
                </div>
